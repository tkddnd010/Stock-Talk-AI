...
const TypewriterBubble = ({ text }: { text: string}) => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 p-4 md:p-8 font-sans">
      <div className="max-w-3xl mx-auto flex flex-col h-[90vh]">
        ...
        {/* 채팅창 영역 */}
        <div ref={chatContainerRef} onScroll={handleScroll} className="flex-1 overflow-y-auto bg-gray-800 p-4 rounded-b-xl shadow-lg space-y-6">
          {messages.length === 0 ? (
              ...
              <div key={index} className="flex flex-col animate-fade-in-up">
                ...
                <div className={`p-3 rounded-2xl max-w-[90%] leading-relaxed shadow-sm inline-block ${
                  ...
                  {index < messages.length - 1 ? (
                    ...
                    <TypewriterBubble text={msg.message} />
                  )}
                </div>
              </div>
            ))
